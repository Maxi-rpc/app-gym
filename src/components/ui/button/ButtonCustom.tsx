...
const ButtonCustom: React.FC<ButtonCustomProps> = ({
    ...
    const colorClasses: Record<ButtonVariant, Record<ButtonColor, string>> = {
        ...
        outline: {
            primary:
                'bg-transparent text-brand-500 ring-1 ring-inset ring-brand-500 hover:bg-brand-50 disabled:text-brand-300 disabled:ring-brand-300 dark:hover:bg-brand-500/[0.12]',
            success:
                'bg-transparent text-green-600 ring-1 ring-inset ring-green-500 hover:bg-green-50 disabled:text-green-300 disabled:ring-green-300 dark:hover:bg-green-500/[0.12]',
            ...
            warning:
                'bg-transparent text-amber-600 ring-1 ring-inset ring-amber-500 hover:bg-amber-50 disabled:text-amber-300 disabled:ring-amber-300 dark:hover:bg-amber-500/[0.12]',
        ...
        text: {
            primary:
                'bg-transparent text-brand-500 hover:bg-brand-50 disabled:text-brand-300 dark:hover:bg-brand-500/[0.12]',
            success:
                'bg-transparent text-green-600 hover:bg-green-50 disabled:text-green-300 dark:hover:bg-green-500/[0.12]',
            error: 'bg-transparent text-red-600 hover:bg-red-50 disabled:text-red-300 dark:hover:bg-red-500/[0.12]',
            warning:
                'bg-transparent text-amber-600 hover:bg-amber-50 disabled:text-amber-300 dark:hover:bg-amber-500/[0.12]',
