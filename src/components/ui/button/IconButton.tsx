...
interface ButtonProps {
    ...
    color?:
        'primary' | 'success' | 'error' | 'warning' | 'info' | 'light' | 'dark'; // Button color
...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        contained: {
            ...
            light: 'bg-light-500 text-white shadow-theme-xs hover:bg-light-600 disabled:bg-light-300',
        ...
        outline: {
            ...
            error: 'bg-error text-error-700 ring-1 ring-inset ring-error-300 hover:bg-error-50 dark:bg-error-800 dark:text-error-400 dark:ring-error-700 dark:hover:bg-error/[0.03] dark:hover:text-error-300',
            warning:
            ...
            light: 'bg-light text-light-700 ring-1 ring-inset ring-light-300 hover:bg-light-50 dark:bg-light-800 dark:text-light-400 dark:ring-light-700 dark:hover:bg-light/[0.03] dark:hover:text-light-300',
