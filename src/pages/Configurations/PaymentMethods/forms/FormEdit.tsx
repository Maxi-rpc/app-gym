...
import { UpdatePaymentMethodsInput } from "../../../../service/types/PaymentMethods";
import { paymentMethodsService } from "../../../../service/paymentMethods.service";

type Props = {
	onSubmit?: () => void;
	onClose?: () => void;
	defaultData: UpdatePaymentMethodsInput | null;
};
...
export default function FormEdit({ onSubmit, onClose, defaultData }: Props) {
	...
	const handleSubmit = async () => {
		try {
			...
			const resp = await paymentMethodsService.update(formData);
			if (resp.error) {
				throw resp.error;
			}
