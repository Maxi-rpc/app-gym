...
import { UpdateProductCategoriesInput } from "../../../../service/types/ProductCategories";
import { productCategoriesService } from "../../../../service/productCategories.service";

type Props = {
	onSubmit?: () => void;
	onClose?: () => void;
	defaultData: UpdateProductCategoriesInput | null;
};
...
export default function FormEdit({ onSubmit, onClose, defaultData }: Props) {
	...
	const handleSubmit = async () => {
		try {
			...
			const resp = await productCategoriesService.update(formData);
			if (resp.error) {
				throw resp.error;
			}
