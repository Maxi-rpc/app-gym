...
import { UpdateProductStatusInput } from "../../../../service/types/ProductStatus";
import { productStatusService } from "../../../../service/productStatus.service";

type Props = {
	onSubmit?: () => void;
	onClose?: () => void;
	defaultData: UpdateProductStatusInput | null;
};
...
export default function FormEdit({ onSubmit, onClose, defaultData }: Props) {
	...
	const handleSubmit = async () => {
		try {
			...
			const resp = await productStatusService.update(formData);
			if (resp.error) {
				throw resp.error;
			}
