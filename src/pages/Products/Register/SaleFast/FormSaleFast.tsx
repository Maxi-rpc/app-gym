...
import SaleItemsTable from "./forms/SaleItemsTable";
import SaleSummary from "../forms/SaleSummary";

import { SaleItem, getItemTotal } from "../forms/sale.types";

export default function FormSaleFast() {
